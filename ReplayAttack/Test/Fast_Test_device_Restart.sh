...
do
   ...
   python3 ReplayAttack.py Result/$MAC_DEVICE/Experiments/Real_Time/Experiment_1/capture.pcap $MAC_SMARTPHONE $MAC_DEVICE $delay_time $MODEL_FOLDER > $EXP_FOLDER/res.txt
